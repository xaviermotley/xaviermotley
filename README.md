...
<p>A structured leadership portfolio that outlines the operating models, governance frameworks, and program architectures I use to build and lead modern security organizations.</p>
<ul>
<li><a href="security-leadership-portfolio/01-security-operating-model.md">Security Operating Model</a></li>
<li><a href="security-leadership-portfolio/02-data-protection-and-privacy-leadership.md">Data Protection &amp; Privacy Leadership</a></li>
<li><a href="https://github.com/xaviermotley/creative-content-security-lab">Content Security &amp; Creative Pipeline Protection</a></li>
<li><a href="security-leadership-portfolio/03-ai-llm-security-and-governance.md">AI/LLM Security &amp; Governance</a></li>
<li><a href="security-leadership-portfolio/04-enterprise-risk-governance.md">Enterprise Risk Governance</a></li>
<li><a href="security-leadership-portfolio/05-incident-response-and-crisis-leadership.md">Incident Response &amp; Crisis Leadership</a></li>
<li><a href="security-leadership-portfolio/06-global-security-org-design.md">Global Security Org Design</a></li>
<li><a href="security-leadership-portfolio/07-culture-talent-and-team-development.md">Culture, Talent, and Team Development</a></li>
<li><a href="security-leadership-portfolio/08-90-day-executive-plans.md">90-Day Executive Plans (for creative, AI, research, and engineering-driven orgs)</a></li>
<li><a href="security-leadership-portfolio/09-board-and-executive-communication-patterns-and-templates.md">Board &amp; Executive Communication Patterns and Templates</a></li>
</ul>
...
<li><b><a href="https://github.com/xaviermotley/aws-vanta-grc-autopilot/blob/main/README.md">AWS ↔ Vanta GRC Autopilot (event-driven, serverless, OSCAL-ready)</a></b> - Build an event-driven, serverless pipeline that turns AWS compliance signals (AWS Config, Security Hub, Security Lake/OCSF) into live Vanta evidence & custom control status via the Vanta API.</li>
